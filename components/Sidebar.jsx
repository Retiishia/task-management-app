...
export default function Sidebar({
  ...
  const navItems = [
    ...
    { id: 'kanban',    label: 'My Tasks',     icon: ListTodo },
      ...
      >
        ...
        <div className="p-5 flex items-center justify-between border-b" style={{ borderColor: 'var(--border)' }}>
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="text-sm font-bold" style={{ color: 'var(--text-primary)' }}>TaskFlow</p>
              <p className="text-[10px]" style={{ color: 'var(--text-muted)' }}>Pro</p>
            </div>
          </div>
          {/* Mobile close button */}
        ...
        <div className="p-3 space-y-0.5 border-t" style={{ borderColor: 'var(--border)' }}>
          {user && (
            <>
              <button
                onClick={() => { onOpenNewTaskModal('todo'); onMobileClose?.(); }}
